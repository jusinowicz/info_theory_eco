...
library(CVXR)
source("./birth_deathR/bde_functions2.R")
#=============================================================================
...
#Upper diagonal is (density dependent) birth 
diag(Q[,-1])[2:Ki] =(1+diag(Qp[-1,])*bs*(1- (diag(Q[-1,]))/Ki))[1:(Ki-1)]
