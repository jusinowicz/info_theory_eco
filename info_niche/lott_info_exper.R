...
# 
# In this version of the code, the goal is to use the model to first
# generate a data set that is similar to something we might really find. Then
# to compare the analysis of the data set to the "true" model. 
#
