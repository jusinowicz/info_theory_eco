...
# model of resource-consumer dynamics. This is to first attempt, to ask the 
# question, is it even meaningful to think in these terms for a deterministic model? 
# 
